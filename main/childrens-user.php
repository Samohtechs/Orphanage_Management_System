        ...
        <div class="row-fluid">
            ...
            <div class="span10">
                <div class="contentheader">
                    <i class="icon-table"></i>List of all Children 
                </div>
                <ul class="breadcrumb">
                ...
                <a href="childrens1-user.php">
					<Button type="submit" class="btn btn-info"
                        style="float:right; width:230px; height:35px;" /><i class="icon- icon-large"></i>Remove Actions
					</button>
				</a>
				<br><br>
                <center>
                ...
                <table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;" id="content2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a title="Click to view the Student" href="viewchild1.php?id=<?php echo $row['id']; ?>">
                                    <button class="btn btn-success btn-mini"><i class="icon-search"></i> View</button>
                                </a>
                                <a title="Click to edit the Student" href="editchild1.php?id=<?php echo $row['id']; ?>">
